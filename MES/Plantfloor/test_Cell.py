...
class testCell(unittest.TestCase):
    ...
    def test_arrangeSteps(self):
        ...
        self.assertEqual(steps[0], (0,'T1',45))
        self.assertEqual(steps[1], (1,'T2',15))
        self.assertEqual(steps[2], (1,'T2',25))
        recipe = {'Piece': 'P7', 'Material': 'P1', 'Time': '45;15;15', 'Tools': 'T1;T2;T3'}
        steps = cell.__arrangeSteps__(recipe)
        self.assertEqual(len(steps), 3)
        self.assertEqual(steps[0], (0,'T1',45))
        self.assertEqual(steps[1], (1,'T2',15))
        self.assertEqual(steps[2], (1,'T3',15))
        recipe = {'Piece': 'P9', 'Material': 'P2', 'Time': '45;45', 'Tools': 'T1;T5'}
        steps = cell.__arrangeSteps__(recipe)
        self.assertEqual(len(steps), 2)
        self.assertEqual(steps[0], (0,'T1',45))
        self.assertEqual(steps[1], (1,'T5',45))
    ...
    def test_removeDoneSteps(self):
        ...
        self.assertEqual(steps1[0], (0,'T1',45))

        recipe = {'Piece': 'P7', 'Material': 'P1', 'Time': '45;15;15', 'Tools': 'T1;T2;T3'}
        steps2 = cell.__arrangeSteps__(recipe)
        self.assertEqual(len(steps2), 3)
        self.assertEqual(steps2[0], (0,'T1',45))
        ...
        self.assertNotEqual(stepsList[0], [(0,'T1',45), (1,'T2',15), (1,'T2',25)])
        self.assertEqual(stepsList[0], [(1,'T2',15), (1,'T2',25)])
        self.assertNotEqual(stepsList[1], [(0,'T1',45), (1,'T2',15), (1,'T3',15)])
        self.assertEqual(stepsList[1], [(1,'T2',15), (1,'T3',15)])
